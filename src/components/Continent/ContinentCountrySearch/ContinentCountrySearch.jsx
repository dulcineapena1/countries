...
const ContinentCountrySearch = (props) => {
  ...
  let search_icon = (
    <svg class='bi bi-search searchIcon' width='1em' height='1em' viewBox='0 0 16 16' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
  ...
  let input = (
    <input
      ...
      id={'countrySearch'}
      name={'countrySearch'}
      className={'countrySearchInput pl-5 p-2'}
